...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Station.record_dir'
        db.add_column('telecaster_station', 'record_dir',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Station.deefuzzer_file'
        db.add_column('telecaster_station', 'deefuzzer_file',
                      self.gf('telemeta.models.core.FileField')(default='', max_length=100, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Station.record_dir'
        db.delete_column('telecaster_station', 'record_dir')

        # Deleting field 'Station.deefuzzer_file'
        db.delete_column('telecaster_station', 'deefuzzer_file')
