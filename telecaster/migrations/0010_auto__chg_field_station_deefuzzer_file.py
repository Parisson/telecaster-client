...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('telecaster_station', 'deefuzzer_file', self.gf('django.db.models.fields.FilePathField')(path='/home/.www-data/.telecaster', max_length=100))
    ...
    models = {
        ...
        'telecaster.station': {
            ...
            'deefuzzer_file': ('django.db.models.fields.FilePathField', [], {'path': "'/home/.www-data/.telecaster'", 'max_length': '100', 'blank': 'True'}),
