...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('telecaster_station', 'conference_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teleforma.Conference']))

        # Changing field 'Station.public_id'
        db.alter_column('telecaster_station', 'public_id', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Station.format'
        db.alter_column('telecaster_station', 'format', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Station.started'
        db.alter_column('telecaster_station', 'started', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Station.pid'
        db.alter_column('telecaster_station', 'pid', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Station.deefuzzer_file'
        db.alter_column('telecaster_station', 'deefuzzer_file', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'Station.record_dir'
        db.alter_column('telecaster_station', 'record_dir', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'OSC.host'
        db.alter_column('telecaster_osc', 'host', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'OSC.port'
        db.alter_column('telecaster_osc', 'port', self.gf('django.db.models.fields.IntegerField')())
    def backwards(self, orm):

        # Changing field 'Station.conference'
        db.alter_column('telecaster_station', 'conference_id', self.gf('telemeta.models.core.ForeignKey')(to=orm['teleforma.Conference']))

        # Changing field 'Station.public_id'
        db.alter_column('telecaster_station', 'public_id', self.gf('telemeta.models.core.CharField')(max_length=255))

        # Changing field 'Station.format'
        db.alter_column('telecaster_station', 'format', self.gf('telemeta.models.core.CharField')(max_length=100))

        # Changing field 'Station.started'
        db.alter_column('telecaster_station', 'started', self.gf('telemeta.models.core.BooleanField')())

        # Changing field 'Station.pid'
        db.alter_column('telecaster_station', 'pid', self.gf('telemeta.models.core.IntegerField')(null=True))

        # Changing field 'Station.deefuzzer_file'
        db.alter_column('telecaster_station', 'deefuzzer_file', self.gf('telemeta.models.core.FileField')(max_length=100))

        # Changing field 'Station.record_dir'
        db.alter_column('telecaster_station', 'record_dir', self.gf('telemeta.models.core.CharField')(max_length=255))

        # Changing field 'OSC.host'
        db.alter_column('telecaster_osc', 'host', self.gf('telemeta.models.core.CharField')(max_length=255))

        # Changing field 'OSC.port'
        db.alter_column('telecaster_osc', 'port', self.gf('telemeta.models.core.IntegerField')())
    models = {
        'auth.group': {
        ...
        'telecaster.station': {
            ...
            'deefuzzer_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True'}),
            ...
            'record_dir': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
